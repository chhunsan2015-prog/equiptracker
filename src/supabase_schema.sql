...
('PROV_BMC', 'បន្ទាយមានជ័យ', 'Banteay Meanchey', 'province', 'សុន វិបុល'),
('PROV_BAT', 'បាត់ដំបង', 'Battambang', 'province', 'គង់ សុជាតិ'),
('PROV_KPC', 'កំពង់ចាម', 'Kampong Cham', 'province', 'ម៉ៅ សំណាង'),
('PROV_KCH', 'កំពង់ឆ្នាំង', 'Kampong Chhnang', 'province', 'លី វាសនា'),
('PROV_KSP', 'កំពង់ស្ពឺ', 'Kampong Speu', 'province', 'សេន ពិសិដ្ឋ'),
('PROV_KPT', 'កំពង់ធំ', 'Kampong Thom', 'province', 'កែម សារឿន'),
('PROV_KOT', 'កំពត', 'Kampot', 'province', 'ភា រិទ្ធ'),
('PROV_KDL', 'កណ្តាល', 'Kandal', 'province', 'ឈាង ឡុង'),
('PROV_KKG', 'កោះកុង', 'Koh Kong', 'province', 'ណាក់ វីរៈ'),
('PROV_KRE', 'ក្រចេះ', 'Kratie', 'province', 'អ៊ុំ ភក្តី'),
('PROV_MDK', 'មណ្ឌលគិរី', 'Mondulkiri', 'province', 'សន តារា'),
('PROV_PNH', 'ភ្នំពេញ', 'Phnom Penh', 'province', 'ឡៅ ម៉េងហួរ'),
('PROV_PRE', 'ព្រះវិហារ', 'Preah Vihear', 'province', 'កែវ សុខា'),
('PROV_PVG', 'ព្រៃវែង', 'Prey Veng', 'province', 'សុវណ្ណ តារា'),
('PROV_PST', 'ពោធិ៍សាត់', 'Pursat', 'province', 'ហេង ណារ៉ុង'),
('PROV_RAT', 'រតនគិរី', 'Ratanakiri', 'province', 'យ៉ែន យុទ្ធ'),
('PROV_SIH', 'ព្រះសីហនុ', 'Preah Sihanouk', 'province', 'ខៀវ សារ៉ាត់'),
('PROV_STR', 'ស្ទឹងត្រែង', 'Stung Treng', 'province', 'ហៅ ចំរើន'),
('PROV_SVR', 'ស្វាយរៀង', 'Svay Rieng', 'province', 'ស៊ឹម សុភ័ក្ត្រ'),
('PROV_TKE', 'តាកែវ', 'Takeo', 'province', 'ម៉ៅ វាសនា'),
('PROV_OMC', 'ឧត្តរមានជ័យ', 'Oddar Meanchey', 'province', 'ហាក់ សេងលី'),
('PROV_KEP', 'កែប', 'Kep', 'province', 'ហឿន វុទ្ធី'),
('PROV_PLN', 'បៃលិន', 'Pailin', 'province', 'ញ៉ែម សុផាត'),
